...
public class BuildTimelineDateTodayListView extends BaseCustomViewGroup {
    ...
    public BuildTimelineDateTodayListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
    ...
    public BuildTimelineDateTodayListView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public BuildTimelineDateTodayListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
