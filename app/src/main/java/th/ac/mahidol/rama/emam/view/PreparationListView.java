...
public class PreparationListView extends BaseCustomViewGroup {

    private TextView tvPatient, tvBedNo, tvMrn;

    public PreparationListView(Context context) {
        super(context);
        initInflate();
        initInstances();
    }

    public PreparationListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
    ...
    public PreparationListView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public PreparationListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
