...
public class BuildCurrentMedTomorrowListView extends BaseCustomViewGroup {

    private TextView tvDrugName, tvDosage, tvType, tvRoute, tvFrequency, tvSite, tvStatus, tvDate;
    private LinearLayout bg;
    private Date date;
    private String dateTomorrow[], year[];

    public BuildCurrentMedTomorrowListView(Context context) {
        super(context);
        initInflate();
        initInstances();
    }

    public BuildCurrentMedTomorrowListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
    ...
    public BuildCurrentMedTomorrowListView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public BuildCurrentMedTomorrowListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
