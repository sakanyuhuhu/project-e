...
public class History_PrepareActivity extends AppCompatActivity {
...
//        initInstance(savedInstanceState);
    ...
    private void  initInstance(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().add(R.id.contentContainer, BuildHistory_PreparationFragment.newInstance(nfcUID, sdlocID, wardName, position)).commit();
        }
    }
