...
public class BuildDoubleCheckAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        BuildDoubleCheckListView doubleCheckListView;
        doubleCheckListView = new BuildDoubleCheckListView(viewGroup.getContext());
        doubleCheckListView.setPatient(dao.getPatientDao().get(position).getBedID(), dao.getPatientDao().get(position).getInitialName()+
