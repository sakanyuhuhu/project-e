...
public class PatientListView extends BaseCustomViewGroup {
    ...
    public PatientListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
    ...
    public PatientListView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public PatientListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.view_list_patient, this);
    }
