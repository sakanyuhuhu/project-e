...
public class PreparationForPatientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().add(R.id.contentContainer, BuildPreparationForPatientFragment.newInstance(sdlocID, wardName, RFID, firstName, lastName, timeposition, position, time)).commit();
        }
    }
