...
public class TimelineDateTomorrowListView extends BaseCustomViewGroup {
    ...
    public TimelineDateTomorrowListView(Context context) {
        super(context);
        initInflate();
        initInstances();
    }

    public TimelineDateTomorrowListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
    ...
    public TimelineDateTomorrowListView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public TimelineDateTomorrowListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
